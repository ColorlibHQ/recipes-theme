...
// image default alt
if ( ! function_exists( 'recipes_img_default_alt' ) ) {
	function recipes_img_default_alt( $url = '' ) {
...
// Image Tag
if ( ! function_exists( 'recipes_img_tag' ) ) {
	function recipes_img_tag( array $args ) {
		...
		if ( ! empty( $args['alt'] ) ) {
			...
			$alt = recipes_img_default_alt( $url );
		}
...
// Anchor Tag
if ( ! function_exists( 'recipes_anchor_tag' ) ) {
	function recipes_anchor_tag( array $args ) {
...
// Heading Tag
if ( ! function_exists( 'recipes_heading_tag' ) ) {
	function recipes_heading_tag( array $args ) {
...
// Paragraph Tag
if ( ! function_exists( 'recipes_paragraph_tag' ) ) {
	function recipes_paragraph_tag( array $args ) {
...
// Other Tag
if ( ! function_exists( 'recipes_other_tag' ) ) {
	function recipes_other_tag( array $args ) {
...
// Button Element 
if ( ! function_exists( 'recipes_button_element ' ) ) {
	function recipes_button_element( array $args ) {
