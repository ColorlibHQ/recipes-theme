...
// enqueue css
function recipes_common_custom_css(){
    
    wp_enqueue_style( 'recipes-common', get_template_directory_uri().'/assets/css/common.css' );

		$whiteColor     		  	= '#ffffff';
		$themeColor     		  	= recipes_opt( 'recipes_theme_color' ) != '#131313' ? recipes_opt( 'recipes_theme_color' ) : '';
		$themeSecColor     		  	= '';
		$bookBtnColor       		= recipes_opt( 'recipes_book_btn_color' ) != '#131313' ? recipes_opt('recipes_book_btn_color') : '';
		$bookBtnHoverBgColor     	= recipes_opt( 'recipes_book_btn_hvr_bg_color' ) != '#131313' ? recipes_opt('recipes_book_btn_hvr_bg_color') : $themeColor;
		$hoverColor     	  	  = recipes_opt( 'recipes_quote_btn_hvr_text_color');

		$headerTop_bg     		  = '';
		$navbarBgColor     		  = recipes_opt( 'recipes_navbar_bg_color' ) != '#082b49' ? recipes_opt( 'recipes_navbar_bg_color') : '';
		$headerTop_col     		  = recipes_opt( 'recipes_top_header_color' );

		$headerTopBg      		  = recipes_opt( 'recipes_top_header_bg_color');
		$headerBg          		  = recipes_opt( 'recipes_header_bg_color') != '#ffffff' ? recipes_opt( 'recipes_header_bg_color') : '';
		$menuColor          	  = recipes_opt( 'recipes_header_menu_color' ) != '#131313' ? recipes_opt('recipes_header_menu_color') : '';
		$menuHoverColor           = recipes_opt( 'recipes_header_menu_hover_color' ) != '#808080' ? recipes_opt('recipes_header_menu_hover_color') : $themeColor;
		$menuFixedHoverColor      = recipes_opt( 'recipes_header_menu_fixed_hover_color' );
		$dropMenuBgColor          = recipes_opt( 'recipes_header_drop_menu_bg_color' ) != '#ffffff' ? recipes_opt('recipes_header_drop_menu_bg_color') : $themeColor;
		$dropMenuColor            = recipes_opt( 'recipes_dropdown_menu_color' ) != '#131313' ? recipes_opt('recipes_dropdown_menu_color') : '';
		$dropMenuHovColor         = recipes_opt( 'recipes_dropdown_menu_hover_color' ) != '#808080' ? recipes_opt('recipes_dropdown_menu_hover_color') : $themeColor;

		$footerwbgColor     	  = recipes_opt( 'recipes_footer_widget_bg_color' );
		$footerwHeadColor   	  = recipes_opt('recipes_footer_widget_heading_color');
		$footerwTextColor   	  = recipes_opt('recipes_footer_widget_text_color');
		$footerwanchorcolor 	  = recipes_opt('recipes_footer_widget_anchor_color') != '#ffffff' ? recipes_opt('recipes_footer_widget_anchor_color') : '';
		$footerwanchorhovcolor    = recipes_opt('recipes_footer_widget_anchor_hover_color') != '#ffffff' ? recipes_opt('recipes_footer_widget_anchor_hover_color') : '';
		
		$fofbg					  = recipes_opt('recipes_fof_bg_color');
		$foftonecolor			  = recipes_opt('recipes_fof_textone_color');
		$fofttwocolor			  = recipes_opt('recipes_fof_texttwo_color');

		$bannerBtnHeaderSpanColor = $themeColor != '#ff5e13' ? $themeColor : '';
		$footerAncDefColor 		  = recipes_opt('recipes_footer_widget_anchor_color') != '#9e9e9e' ? recipes_opt('recipes_footer_widget_anchor_color') : '';
		...
		$customcss ="			
			...
			.footer-area .single-footer-widget .btn, .footer .footer_top .footer_widget .recipes_mailchimp_newsletter_widget button, .footer .footer_top .footer_widget .recipes_mailchimp_newsletter_widget button
			{
    ...
    wp_add_inline_style( 'recipes-common', $customcss );
    
}
add_action( 'wp_enqueue_scripts', 'recipes_common_custom_css', 50 );